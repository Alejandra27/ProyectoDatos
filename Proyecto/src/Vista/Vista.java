...
public class Vista implements ActionListener{
	    ...
	    public void actionPerformed(ActionEvent arg0) {
	        ...
	        if (arg0.getSource() == botao) {
	            ...
	            // Cria funcionario
	            Pasajero funcionario = new Pasajero();
	 
	            // Busca funcionario
	            funcionario = new PasajeroDAO().buscaFuncionario(tpesquisa
	                    .getText());
	...
	public Vista() throws Exception{
		...
		Controlador socket = new Controlador();
		int nuevo = 1517; 
